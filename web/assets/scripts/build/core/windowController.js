...
define(["require", "exports", 'core/logger'], function(require, exports, Logger) {
    ...
    (function (WindowController) {
        var log = Logger.log, $win = $(window), BINDINGS = [], bindThreshold = 100, bindThresholdTimer, lastTop = -1, lastDimensions = -1, hasScrolled = false, hasResized = false, runEventsTemp = null, runEventsSTop = null, runEventsWinWidth = null, runEventsWinHeight = null, runEventsTempType = null, runNewDimensions = null, runFuncArray = null;
        ...
        */
        function bindWindow() {
            ...
            $win.on('resize', function (e) {
                if (hasScrolled && 'ontouchstart' in window) {
                    hasScrolled = true;
                    hasResized = true;
                } else {
                    hasResized = true;
        ...
        */
        function runEvents(force) {
            ...
            for (var i = BINDINGS.length; i > 0; --i) {
                ...
                if ((runEventsTempType === 'scroll' && (force || (hasScrolled && runEventsSTop !== lastTop))) || (runEventsTempType === 'resize' && (force || (hasResized && runNewDimensions !== lastDimensions)))) {
                    // runEventsTemp.fn.apply(runEventsTemp.context, [{
                    //     'winWidth': runEventsWinWidth,
                    //     'winHeight': runEventsWinHeight,
                    //     'scrollTop': runEventsSTop,
                    //     'scrollBottom': runEventsSTop + runEventsWinHeight
                    // }]);
                    runFuncArray.push((function (runEventsTemp, runEventsWinWidth, runEventsWinHeight, runEventsSTop, i) {
                    ...
                    })(runEventsTemp, runEventsWinWidth, runEventsWinHeight, runEventsSTop, i));
                }
            }

            async.parallel(runFuncArray, function (err, results) {
