define(["require", "exports"], function(require, exports) {
    ...
    var Logger;
    (function (Logger) {
        var logHistory = [], $body = $(document.body), isDebug = $body.attr('data-debug') ? ($body.attr('data-debug') === 'true' ? true : false) : false, showLineNumbers = $body.attr('data-debug-lines') ? ($body.attr('data-debug-lines') === 'true' ? true : false) : false, errorCount = 0;
        ...
        */
        (function (Analytics) {
            var analyticsHistory = [], TRACKABLES = {}, IS_ENABLED = true, _init = false;
        ...
        function enableLineNumbers(yesno) {
            if (yesno === true) {
        ...
        window['debug_log'] = window['debug_log'] || {
            ...
            'force': function (yesno, withLines) {
                if (typeof withLines === "undefined") { withLines = false; }
                isDebug = yesno;
