...
import PushState = require('core/pushState');
 ...
 */
export class FbObject extends Loggable {
	$root:JQuery;
	$html:JQuery = $('html');
 ...
 * @extends Base.FbObject
 * @class Widget
 */
export class Widget extends FbObject {
     ...
     * also calls FbObject.dispose (removes window events)
     */
	dispose():void {
		super.dispose();
		if(this && this.$root){
